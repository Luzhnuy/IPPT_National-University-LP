					...
					<div class="col-12 col-lg-3">
						<div class="about-us-navbar">
							<ul class="nav nav-tabs about-us-tabs" role="tablist">
								...
								<li role="presentation"><a class="post-text" href="#deanery" aria-controls="deanery" role="tab" data-toggle="tab">Деканати базової та повної вищої освіти</a></li>
						...
						<div class="tab-content">
								    		...
								    		<div class="row no-gutters">
								    			...
								    			<div class="col-12 col-lg-7">
								    				<div class="leadership-text">
								    					...
								    					<h5 class="text-aqua">Директор</h5>
								    					<p>к.т.н., доцент, заслужений працівник освіти України, відмінник освіти України</p>
								    					<p>
								    						Тел: <span class="text-aqua">258-20-27</span>
								    						<br>
								    						E-mail: <span class="text-aqua">dir.ippt@gmail.com</span>
								    					</p>
								    				</div>
								    			</div>
								    		</div>
								    		...
								    		<div class="row no-gutters">
								    			...
								    			<div class="col-12 col-lg-7">
								    				<div class="leadership-text">
								    					...
								    					<h5 class="text-aqua">Заступник директора</h5>
								    					<p>к.ф.-м.н., доцент, нагороджений Почесною грамотою Міністерства освіти і науки України</p>
								    					<p>
								    						Тел: <span class="text-aqua">258-26-76</span>
								    						<br>
								    						E-mail: <span class="text-aqua">yslyusarchuk@ukr.net</span>
								    					</p>
								    				</div>
								    			</div>
								    		</div>
								    		...
								    		<div class="row no-gutters">
								    			...
								    			<div class="col-12 col-lg-7">
								    				<div class="leadership-text">
								    					...
								    					<p>к.т.н., доцент, заслужений працівник освіти України, відмінник освіти України</p>
								    					<p>
								    						Тел: <span class="text-aqua">258-21-67</span>
								    						<br>
								    						E-mail: <span class="text-aqua">email@email.net</span>
								    					</p>
								    				</div>
								    			</div>
								    		</div>
							...
							<div role="tabpanel" class="tab-pane fade" id="theDepartment">
								...
								<div class="the-department-card">
								    ...
								    <p>
								    	Завідувач кафедри: <span>Теслюк Василь Миколайович</span>
								    	<br>
								    	Адреса: <span>вул. Горбачевського, 18, 32-й н.к., кім. 506, 402</span>
								    	<br>
								    	Телефон: <span>(032) 258-24-75</span>
								    	<br>
								...
								<div class="the-department-card">
								    ...
								    <p>
								    	Завідувач кафедри: <span>Лисяк Наталя Михайлівна</span>
								    	<br>
								    	Адреса: <span>вул. Горбачевського, 18, 32-й н.к., кім. 301, 408</span>
								    	<br>
								    	Телефон: <span>(032) 258-24-86</span>
								    	<br>
								...
								<div class="the-department-card">
								    ...
								    <p>
								    	Завідувач кафедри: <span>Гориславець Павло Анатолійович</span>
								    	<br>
								    	Адреса: <span>вул. Горбачевського, 18, 32-й н.к., кім. 308</span>
								    	<br>
								    	Телефон: <span>(032) 258-25-68</span>
								    	<br>
							...
							<div role="tabpanel" class="tab-pane fade" id="deanery">
										...
										<div class="deanery-employee">
											<p>
												<span class="text-bold">Декан:</span> Лапішко Марія Львівна, к.е.н., професор <br>
												<span class="text-bold">Адреса:</span> вул. Горбачевського, 18, кім. 201, 106. <br>
												<span class="text-bold">Номер телефону:</span> (032) 258-21-06 <br>
												<span class="text-bold">Е-mail:</span> mariia.l.lapishko@lpnu.ua <br>
											</p>
										</div>
										<div class="deanery-employee">
											<p>
												<span class="text-bold">Фахівець деканату  по роботі з студентами денної форми навчання:</span>
												Хованець Галина Михайлівна <br>
												<span class="text-bold">Е-mail:</span> Galina.M.Khovanets@lpnu.ua <br>
											</p>
										</div>
										<div class="deanery-employee">
											<p>
												<span class="text-bold">Фахівець деканату  по роботі з студентами денної форми навчання:</span>
												Лозинська Галина Ярославівна <br>
												<span class="text-bold">Е-mail:</span> Galina.Y.Lozinska@lpnu.ua <br>
											</p>
										</div>
										...
										<ul>
											<li>071 – <span class="text-aqua">«Облік і оподаткування»</span></li>
											<li>072 – <span class="text-aqua">«Фінанси, банківська справа та страхування»</span></li>
											<li>075 – <span class="text-aqua">«Маркетинг»</span></li>
											<li>122 – <span class="text-aqua">«Комп’ютерні науки»</span></li>
										</ul>
										...
										<ul>
											<li><span class="text-aqua">Кафедра  фінансів, обліку і аналізу</span> <br>( завідувач –  к.е.н., доцент Гориславець П.А.)</li>
											<li><span class="text-aqua">Кафедра економіки і маркетингу</span> <br>(завідувач – к.е.н., доцент Лисяк Н.М.)</li>
											<li><span class="text-aqua">Кафедра інформаційних систем і технологій</span> <br>(завідувач – д.т.н., професор  Теслюк В.М.)</li>
										</ul>
										...
										<ul>
											<li>Група ФК-35  	–	<span class="text-aqua">Філь Олег Романович</span> </li>
											<li>Група ФК-36	–	<span class="text-aqua">Андріїшин Ірина Степанівна</span> </li>
											<li>Група МК-33	–	<span class="text-aqua">Чвартковська Вікторія Романівна</span> </li>
											<li>Група ОА-44	–	<span class="text-aqua">Пошивак Ярослав Васильович</span> </li>
											<li>Група ФК-45	–	<span class="text-aqua">Гац Христина Андріївна</span> </li>
											<li>Група ФК-46	–	<span class="text-aqua">Дмитрах Юрій Андрійович</span> </li>
											<li>Група МК-43	–	<span class="text-aqua">Батова Вікторія Ігорівна</span> </li>
											<li>Група КН-114  	–	<span class="text-aqua">Барнінець Діана Романівна</span> </li>
											<li>Група КН-223	–	<span class="text-aqua">Майхер Орест Володимирович</span> </li>
											<li>Група КН-39	–	<span class="text-aqua">Гирич Ольга Ігорівна</span> </li>
											<li>Група КН-490	–	<span class="text-aqua">Кувичко Дмитро Юрійович</span> </li>
											<li>Група КН-491 	–	<span class="text-aqua">Матюкевич Мар'яна Олегівна</span> </li>
											<li>Група КНЕМ-11	–	<span class="text-aqua">Демедюк Олег Павлович</span> </li>
											<li>Група КНЕМ-12	–	<span class="text-aqua">Сухинова Карина Володимирівна</span> </li>
											<li>Група КЕМм -21	–	<span class="text-aqua">Очич Ігор Русланович</span> </li>
											<li>Група КЕМс -21	–	<span class="text-aqua">Галай Марія Назарівна</span> </li> 
										</ul>
										...
										<ul>
											<li> <span class="text-aqua">В Перун</span> -  друге місце на Всеукраїнській студентській олімпіаді з дисципліни «Педагогіка» (2017).</li>
											<li> <span class="text-aqua">Н. Боднар, Р. Мотрук, Т. Кушерський, С.  Кулеша,  М. Шеремет</span> —  третє  місце  на  ІХ  Всеукраїнському студентському кейс-змаганні з маркетингу «Rising Industrial Marketing Stars» (2016).</li>
											<li> <span class="text-aqua">В. Крамарець</span> — переможець конкурсу «Завтра.UA» (2014).</li>
											<li> <span class="text-aqua">О. Гринишин</span> — диплом ІІІ ступеня на Всеукраїнському конкурсі студентських робіт з природничих, технічних і гуманітарних наук у галузі науки «Бухгалтерський облік, аналіз і аудит» (2015).</li>
											<li> <span class="text-aqua">Х. Грищук</span> — диплом ІІІ ступеня на Всеукраїнському конкурсі студентських робіт з природничих, технічних і гуманітарних наук у галузі науки «Туризм» (2015).</li>
											<li> <span class="text-aqua">Портак Маркіян</span> – І місце у Всеукраїнському конкурсі студентських робіт за галуззю знань «Екологія та екологічна безпека» (2014).</li>
										</ul>
										...
										<ul>
											<li><span class="text-aqua">Олег Гасьошин </span>– арт – директор компанії «ELEKS»</li>
											<li><span class="text-aqua">Ростислав Гулька</span> – керівник фірми розробки комп’ютерних ігор «711 media development»</li>
											<li><span class="text-aqua">Мар’яна Кавин</span> – директор ТОВ Західна консалтингова група»</li>
											<li><span class="text-aqua">Володимит Бервецький</span> -  тренер департаменту роботи з публікоюТОВ Західна консалтингова група»</li>
											<li><span class="text-aqua">Андрій Седлер</span> – за участь у подіях на Майдані Гідності відзначений державною нагородою</li>
										</ul>
							...
							<div role="tabpanel" class="tab-pane fade" id="college">
								...
								<div class="about-us-college-info">
								    <div class="college-employee">
										<p>
											<span class="text-bold">Директор коледжу:</span> Батьковець  Наталія Олегівна, к.е.н., доцент <br>
											<span class="text-bold">Адреса:</span> вул. Горбачевського, 18, 32-й н.к., кім. 401 <br>
											<span class="text-bold">Номер телефону:</span> (032) 258-26-29  <br>
											<span class="text-bold">Е-mail:</span> Nataliia.O.Batkovets@lpnu.ua <br>
										</p>
									</div>
									<div class="college-employee">
										<p>
											<span class="text-bold">Фахівець деканату :</span> Пиць Мирослава Богданівна <br>
											<span class="text-bold">Е-mail:</span> Miroslava.B.Pyts@lpnu.ua <br>
										</p>
									</div>
									<div class="college-employee">
										<p>
											<span class="text-bold">Фахівець деканату :</span> Лозинська Галина Ярославівна <br>
											<span class="text-bold">Е-mail:</span> Galina.Y.Lozinska@lpnu.ua <br>
										</p>
									</div>
									<div class="img">
							...
							<div role="tabpanel" class="tab-pane fade" id="educationalMethodicalDepartment">
								...
								<div class="educational-methodical-department-content">
									<p>
										<span class="text-bold">Начальник навчально-методичного відділу:</span> ст. викладач Самотій Наталія Степанівна <br>
										<span class="text-bold">Адреса:</span> вул. Горбачевського, 18, Корпус №32, кім. 202 <br>
										<span class="text-bold">Номер телефону:</span> (032) 258-26-86  <br>
										<span class="text-bold">Е-mail:</span> NMV.ippt@lpnu.ua, nataliia.s.samotii@lpnu.ua<br>
									</p>
								</div>
								<p class="text-bold">Працівники відділу:</p>
								<ul>
									<li><span class="text-bold">Заступник начальника НМВ:</span> Чипак Анастасія Андріївна</li>
									<li><span class="text-bold">Фахівець НМВ:</span> Шкільна Валентина Леонідівна</li>
								</ul>
								<div class="row">
								...
								<ul>
									...
									<li>супровід ЄДБО по студентському складу;</li> 
							...
							<div role="tabpanel" class="tab-pane fade" id="researchSector">
								<h2>Науково-дослідний сектор</h2>
								    <p>Comming Soon</p>
							</div>
							...
							<div role="tabpanel" class="tab-pane fade" id="affiliateDrohobych">
								...
								<div class="affiliate-employee">
									<p>
										<span class="text-bold">Директор філії:</span> Гавран Володимир Ярославович, к.е.н., доцент <br>
										<span class="text-bold">Заступник директора філії:</span> Щербан Тарас Йосипович <br>
										<span class="text-bold">Інспектор деканату:</span> Квик Іван Степанович <br>
										<span class="text-bold">Адреса:</span> 82100, м. Дрогобич, вул. С.Стрільців, 2 <br>
										<span class="text-bold">Номер телефону:</span> (03244) 337-35, 213 43 <br>
										<span class="text-bold">Е-mail:</span> Volodymyr.Y.Gavran@lpnu.ua  <br>
									</p>
								</div>
								<p class="text-bold">Здобутки наших студентів:</p>
								<ul>
									<li><span class="text-aqua">Стахнів Марія</span> - 3 місце у Всеукраїнському конкурсі студентських наукових робіт</li>
									<li><span class="text-aqua">Гембарська Марія-Ірина</span> - стипендія Львівської облдержадміністрації та обласної ради</li>
									<li><span class="text-aqua">Марків Марта</span> - відзнака  Дрогобицької міської ради</li>
									<li><span class="text-aqua">Лахман Олег</span> - переможець пісенного конкурсу м. Дрогобича</li>
								</ul>
							...
							<div role="tabpanel" class="tab-pane fade" id="library">
								...
								<div class="about-library">
								    <div class="librarian">
										<p>
											<span class="text-bold">Завідувач бібліотеки:</span> Печериця Яна Богданівна <br>
											<span class="text-bold">Адреса:</span> вул. Горбачевського, 18, кім. 108, 110 <br>
											<span class="text-bold">Номер телефону:</span> (032) 258-26-84  <br>
											<span class="text-bold">Е-mail:</span> Juanna.B.Pecherytsay@lpnu.ua <br>
										</p>
									</div>
									<div class="librarian">
										<p>
											<span class="text-bold">Бібліотекар:</span> Пиць Мирослава Богданівна <br>
										</p>
									</div>
								</div>
								...
								<p>Фінанси України <a href="www.minfin.gov.ua/control/uk/publish/archive" class="text-aqua">www.minfin.gov.ua/control/uk/publish/archive</a></p>
								<p>Економіка і прогнозування <a href="www.eip.org.ua" class="text-aqua">www.eip.org.ua</a></p>
								...
								<p>Баланс. Бюджет <a href="www.balance.ua" class="text-aqua">www.balance.ua</a></p>
								<p>Урядовий кур'єр <a href="www.ukurier.gov.ua" class="text-aqua">www.ukurier.gov.ua</a></p>
								<p>Проблеми економіки <a href="red.poe@mail.ru" class="text-aqua">red.poe@mail.ru</a></p>
								<p>Бізнес Інформ <a href="biz_inf@ukr.net" class="text-aqua">biz_inf@ukr.net</a></p>
								<p>Актуальні проблеми економіки <a href="eco@nam.kiev.ua" class="text-aqua">eco@nam.kiev.ua</a></p>
								<p>Chip. Go Digital DVD <a href="www.chip.ua/zhurnal-chip" class="text-aqua">www.chip.ua/zhurnal-chip</a></p>
								<p>Видання доступні в читальному залі НТБ НУ "Львівська політехніка" (110 ауд.): <a href="http://library.lp.edu.ua/" class="text-aqua">http://library.lp.edu.ua/</a></p>
							</div>
								    
							<div role="tabpanel" class="tab-pane fade" id="contacts">
								<h2>Контакти</h2>
								<p>
								    <span class="text-bold">Адреса:</span> <span>79044, м. Львів, вул. Горбачевського, 18, 32-й н.к.</span>
								    <br>
								    <span class="text-bold">Телефон:</span> <span>(032) 258-20-27б (032) 297-07-55</span>
								    <br>
								    <span class="text-bold">E-mail:</span> <span>IPPT.dept@lpnu.ua,  dir.ippt@gmail.com</span>
								    <br>
								</p>
