...
<a href="https://osonnya.com/"><img src="https://osonnya.com/upload/medialibrary/15a/15a14f057017a1e25ed96963a577d5e4.jpg" border="0" width="230" height="65" alt="Відпочинок в Карпатах" /></a>
<a href="https://galaktika.lviv.ua/vesilniy-zal/"><img src="https://galaktika.lviv.ua/upload/medialibrary/271/2716b1bd8f4785dac15b5a76de8720b6.jpg" border="0" width="230" height="65" alt="Весільний зал" /></a>
					...
					<div class="col-12 col-lg-9">
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active show" id="aboutUs">
								<h2 style="text-align:center;">Про інститут</h2>
								<div class="about-us-info" style='text-align:left;'>
...
1998 року.<br><br>
    За майже 20 років своєї діяльності Інститутом було підготовлено понад
4000 фахівців.<br><br>
Усі ці роки натхненником освітніх інновацій, незмінним керівником
...
медаллю ВДНГ України за технологічну розробку.<br><br>
В травні 2010 року наказом МОН України «Про створення Інноваційного
...
– «бакалавр» - «магістр» на базі Інституту.<br><br>
Інститут готує фахівців на денній і заочній формах навчання за освітньо-
...
«бакалавр», «магістр» з чотирьох спеціальностей на основі ліцензій МОНУ:</p>
		<br><br>
								    <ul>
								    	<li><strong>12 Інформаційних Технологічній</strong>
													<ul><li>122 Комп'ютерні науки
															<ul>
										...
										<ul>
										 <li><strong>07 Управління та адміністрування</strong>
												 <ul><li>072 Фінанси, банківська справа  та страхування
														 <ul>
															 <li>освітній рівень "магістр"</li>
															 <li>освітній рівень "бакалавр"</li>
															 <li>ОКР "молодший спеціаліст"</li>
												 ...
												 <ul><li>071 Облік  і оподаткування
														 <ul>
									 ...
									 <p>
										 Навчання  бакалаврів триває 4 роки.  Наявність інтегрованих навчальних планів  ступеневої освіти дозволяє випускникам  Коледжу інноваційних технологій інституту навчатися за освітньою бакалаврською програмою протягом 2-х років.</p>
										 <p>
										 В Інституті здійснюється півторарічна підготовка магістрів за спеціальностями:</p>
										 <ul>
										 ...
										 ОПП «Фінанси, банківська справа  та страхування».</li>

									 </ul>
									 <p>
										 Діє чітка система профорієнтаційної роботи, яка спрямована  на залучення до вступу у навчальний заклад молоді з усього Західного регіону. Найактивніше ця робота проводиться серед учнів м. Львова, сільських шкіл більшості районів Львівської, Івано-Франківської, Рівненської, Тернопільської областей.</p>
										 <p>
										 ...
										 <p>
										 За остання 5 років працівниками Інституту захищено 19 кандидатських і 1 докторська дисертація, 9 осіб отримали вчене звання доцента.</p>
									...
									<p>
										 понад 800 наукових публікаціях, з них 568 у фахових виданнях, зокрема 5 – у виданнях, що індексуються Scopus).<p>
											 <p>
										 На базі Інституту успішно функціонує Центр моніторингу урбанізованих систем.</p>
										...
										<p style="font-weight:400;"> Навчальний процес  в Інституті реалізовується в окремих корпусах, які розташовані у:  м. Львові ( Вул. Горбачевського, 18). та у м. Дрогобичі ( вул. Січових Стрільців, 2). Тут створені сучасні умови для освітньої діяльності здобувачів освіти: комп’ютерні лабораторії, де розміщено понад 200 комп’ютерів, WI-FI, електронна база  бібліотечного фонду, читальні зали,  їдальня.
										 <br>Студенти Інституту мають можливість розвивати свої особливі творчі та спортивні таланти у гуртках, художніх колективах та спортивних секціях, які  створені і діють у НУ «Львівська політехніка».
										 <br>Усі досягнення – це результат спільної злагодженої роботи колективу Інституту підприємництва та перспективних технологій, який спрямований на формування у молодого покоління навичок навчання протягом усього життя.
										 Майбутнє Інституту твориться з орієнтацією на гасло:</p>
										 <p style="margin-left:35%;">	<strong > «Через навчання до успіху!»</strong>
								    		...
								    		<div class="row no-gutters">
								    			<div class="col-12 col-lg-5">
								    				<div class="leadership-img img">
								    					<img src="sources/img/leadership/ed_Hromiak.jpg" alt="leadership">
								    				</div>
								    			</div>
								    ...
								    <div class="col-12 col-lg-6">
								    	<div class="leadership-card">
								    		<div class="row no-gutters">
								    			<div class="col-12 col-lg-5">
								    				<div class="leadership-img img">
								    					<img src="sources/img/leadership/ed_Tsubov.jpg" alt="leadership">
								    				</div>
								    			</div>
								    			<div class="col-12 col-lg-7">
								    				<div class="leadership-text">
							...
							<!-- 		<div class="college-employee">
									...
									<div class="img college-img">
										<img src="sources/img/college/1.jpg" alt="deanery-img">
										<img src="sources/img/college/2.jpg" alt="deanery-img">
									</div>
